...
# --- 1. MODO PRODUCCIÓN (OCULTAR MENÚS Y FOOTERS) ---
# Este bloque de CSS elimina el menú de hamburguesa, el footer y los enlaces de edición
st.markdown("""
<style>
    /* Ocultar el menú hamburguesa de arriba a la derecha */
    #MainMenu {visibility: hidden;}
    
    /* Ocultar el footer de "Made with Streamlit" */
    footer {visibility: hidden;}
    
    /* Ocultar el header donde sale el título si usas uno propio en el body */
...
def login():
    ...
    with col2:
        ...
        with st.form("login_form"):
            ...
            if submit:
                # Validación simple para producción (en un futuro real esto se encripta en BD)
...
def main_app():
    ...
    with st.sidebar:
        ...
        if st.button("📊 Monitor Dueño", use_container_width=True):
